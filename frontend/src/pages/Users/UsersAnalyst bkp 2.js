...
const UsersAnalyst = ({ myglobalData, dispatch }) => {
  ...
  const handleCheckboxChange = (moduleName, action) => {
    ...
    if (moduleName === "Master Access") {
        ...
        const updatedModuleAccess = selectAllModule ? [] : ["Leads View", "Leads Add", "Leads Edit", "Leads Quick Edit", "Leads Call", "Leads Whatsapp", "Leads Email", "Leads Delete", "Leads Assign", "Leads Import", "Leads Export", "All Broker View", "All Broker Add", "All Broker Edit", "All Broker Call", "All Broker Whatsapp", "All Broker Delete", "All Broker Assign", "All Broker Import", "All Broker Export", "Loan View", "Loan Add", "Loan Edit", "Loan Call", "Loan Whatsapp", "Loan Delete", "Loan Assign", "Loan Import", "Loan Export", "Human Resource View", "Human Resource Add", "Human Resource Edit", "Human Resource Quick Edit", "Human Resource Call", "Human Resource Whatsapp", "Human Resource Email", "Human Resource Delete", "Human Resource Assign", "Human Resource Import", "Human Resource Export", "Users View", "Users Add", "Users Edit", "Users View CRM", "Dynamic Fields View", "Dynamic Fields Add", "Dynamic Fields Edit", "Dynamic Fields Delete", "Change Password Edit"]; 
    ...
    if (action === "Check All") {
        setCheckAllAction((prevCheckAllAction) => {
            ...
            if (newState) {
                updatedModuleAccess.push(...allActionsForModule.map(action => `${moduleName} ${action}`));
            }
  ...
  const getActionsForModule = (moduleName) => {
      switch (moduleName) {
          case "Leads":
              return ["View","Add","Edit","Quick Edit","Call","Whatsapp","Email","Delete","Assign","Import","Export"];
          case "All Broker":
              return ["View","Add","Edit","Call","Whatsapp","Delete","Import","Export"];
          case "Loan":
              return ["View","Add","Edit","Call","Whatsapp","Delete","Import","Export"];
          case "Human Resource":
              return ["View","Add","Edit","Quick Edit","Call","Whatsapp","Email","Delete","Assign","Import","Export"];
          case "Users":
              return ["View","Add","Edit","View CRM"];
          case "Dynamic Fields":
