                    ...
                    FormField={
                      crm_countries.value.includes("India") ? (
                        ...
                        <CustomMultipleSelectField
                          ...
                          options={CreateLabelValueArray(
                            GetAllLocationDropDown?.data || [], // Ensure data exists, use empty array as fallback
                            "location_name"
                          )}
                          isLabelValue={true}
                          FieldValue={setFieldValue}
                          values={values?.locality || []} // Ensure values is properly structured
                        />
                      ) : null
                    }
                  />
                      ...
                      <CustomFormGroup
                        ...
                        FormField={
                          ...
                          <CustomMultipleSelectField
                            ...
                            placeholder="Handover Year"
                            options={CreateLabelValueArray(
                              GetAllHandoverYearDropDown?.data || [], // Ensure data exists, use empty array as fallback
                              "handover_year"
                            )}
                            isLabelValue={true}
                            FieldValue={setFieldValue}
                            values={values?.handover_year || []} // Ensure values is properly structured
                          />
                        }
                      />
