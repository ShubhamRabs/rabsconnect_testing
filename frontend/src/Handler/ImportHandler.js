...
const ImportHandler = ({
  ...
  const { Button, ImageIcon, LinearProgress, CloudDownloadIcon, Alert } =
    useMui();
      ...
      if (fileType === "text/csv" || fileType === "application/vnd.ms-excel") {
        ...
        Papa.parse(uploadedFile, {
          ...
          complete: (results) => {
            ...
            let data = {
              data: dataResult.splice(0, dataResult.length - 1),
              login_u_id: Cookies.get("u_id"),
              login_type: Cookies.get("type"),
              login_username: Cookies.get("username"),
            };
