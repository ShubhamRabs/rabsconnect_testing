...
import { LeadSchedulingColumn } from "../data/Columns/Lead/LeadSchedulingColumn";
...
import LeadScheduleAdvanceSearch from "../components/LeadScheduleAdvanceSearch/LeadScheduleAdvanceSearch";
...
const LeadHandler = ({
  ...
  const leadScheduleTableData = useQuery(
  ...
  //     data = leadScheduleTableData.data?.data;
  //   } else {
  //     data = selectedRows;
  //   }
  ...
  return (
    <>
      ...
      <Card className="mt-3">
        ...
        {!leadScheduleTableData.isLoading && !leadCount.isLoading ? (
          <>
            {searchData === "No Data Found" || searchData.length === 0 ? (
              <CustomDataTable
                actionModulePrevilege={LeadsActionPrevilege}
                columns={LeadSchedulingColumn}
                data={leadScheduleTableData.data?.data}
                page={page}
                pageSize={pageSize}
                totalCount={
