...
const Leftsidebar = ({ dispatch, myglobalData }) => {
  ...
  //   setRemaining((prevRemaining) => Math.ceil(getRemainingTime() / 1000));
  // }, [getRemainingTime]);
  ...
  const SideMenuList = [
    ...
    // {
    //   icon: <StorefrontIcon />,
    //   MenuName: "Marketing Collateral",
    //   Link: "/marketingcollateral",
    //   submenu: "No",
    //   MapFunction: "",
    //   setFunction: "",
    //   onclickFunction: "",
    ...
    <React.Fragment>
      ...
      <Box>
              ...
              >
                {Cookies.get("previous_user") === undefined ? (
                  <>
                    ...
                    >
                      <SettingsIcon sx={{ mr: 1, fontSize: "1.375rem" }} />{" "}
                      Settings
                    </Dropdown.Item>
                    <Dropdown.Item
                      as="button"
        ...
        <footer className="footer">
          ...
          />
          {/* {remaining !== 0 ? (
            <CustomSubTitle SubTitle={"Remaining sec: " + remaining} />
          ) : null}
          <CustomSubTitle SubTitle={"Action Events :- " + formatTime(count)} /> */}
        </footer>
      </Box>
      <CustomModal
        ModalSize="md"
