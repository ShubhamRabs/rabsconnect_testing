...
let initialCountryValue = [];

if (crm_countries.value.includes("India")) {
  initialStateValue = [{ value: "Maharashtra", label: "Maharashtra" }];
} else if (crm_countries.value.includes("UAE")) {
  initialStateValue = [{ value: "Dubai", label: "Dubai" }];
}

if (crm_countries.value.includes("India")) {
  initialCityValue = [{ value: "Mumbai", label: "Mumbai" }];
} else if (crm_countries.value.includes("UAE")) {
  initialCityValue = [{ value: "Dubai", label: "Dubai" }];
}

if (crm_countries.value.includes("India")) {
  initialCountryValue = [{ value: "India", label: "India" }];
} else if (crm_countries.value.includes("UAE")) {
  initialCountryValue = [
...
export { initialCityValue, initialStateValue, initialCountryValue };
